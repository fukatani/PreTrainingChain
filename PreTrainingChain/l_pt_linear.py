...
from c_pt_linear import ptlinear
...
class PTLinear(link.Link):
    ...
    def __init__(self, in_size, out_size, wscale=1, bias=0, nobias=False,
                 initialW=None, initial_bias=None, initial_bias2=None, activation=relu):
    ...
    def __call__(self, x):
        ...
        """
        return ptlinear(x, self.W, self.b, self.b2, self.is_pre_training, self.activation)
